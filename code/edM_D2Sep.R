...
# dyn.load( dynlib("code/modM_D2Sepsparse"))
...

{
  ...
  # optimization took 35.2261500000001 minutes (for intern=FALSE)
}
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitM_D2Sep.RData")
out = load("savedOutput/ed/fitM_D2Sep.RData")
...
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsM_D2Sep.RData")
out = load("savedOutput/ed/gridPredsM_D2Sep.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_D2Sep.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_D2Sep.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_D2Sep.RData")
out = load("savedOutput/ed/stratPredsM_D2Sep.RData")
out = load("savedOutput/ed/admin1PredsM_D2Sep.RData")
out = load("savedOutput/ed/admin2PredsM_D2Sep.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edM_D2Sep")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edM_D2Sep", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edM_D2Sep", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edM_D2Sep", plotNameRootAreal="Admin2")
