...
# (Int) & -1.66 & -1.90 & -1.82 & -1.48 & -1.33 \\ 
# urb & 0.49 & 0.26 & 0.33 & 0.63 & 0.70 \\ 
# access & -0.14 & -0.23 & -0.20 & -0.08 & -0.05 \\ 
# elev & 0.15 & 0.02 & 0.07 & 0.23 & 0.27 \\ 
# distRiversLakes & 0.09 & -0.03 & 0.02 & 0.17 & 0.21 \\ 
# popValsNorm & 0.80 & 0.60 & 0.66 & 0.93 & 0.98 \\ 
# sigmaSq & 0.60 & 0.36 & 0.41 & 0.82 & 0.98 \\ 
# phi & 0.84 & 0.47 & 0.66 & 0.97 & 0.99 \\ 
# sigmaEpsSq & 1.33 & 1.14 & 1.20 & 1.45 & 1.53 \\ 
tmb_params <- list(log_tau = 0.5108256, # Log tau (i.e. log spatial precision, Epsilon)
                   logit_phi = 1.658228, # SPDE parameter related to the range
                   log_tauEps = -0.2851789, # Log tau (i.e. log spatial precision, Epsilon)
                   beta = c(.49, -.14, .15, .09, .80), 
                   w_bym2Star = rep(-1.66, ncol(bym2ArgsTMB$Q)), # RE on mesh vertices
                   u_bym2Star = rep(0, ncol(bym2ArgsTMB$Q)), # RE on mesh vertices
                   nuggetUrbMICS = rep(0, length(data_full$y_iUrbanMICS)), 
                   nuggetRurMICS = rep(0, length(data_full$y_iRuralMICS))
)
...
# dyn.load( dynlib("code/modM_MSepReparsparse"))
...

{
  ...
  # optimization took 8.02791666666647 minutes (for intern=FALSE)
}
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitM_MSepRepar.RData")
out = load("savedOutput/ed/fitM_MSepRepar.RData")

gridPreds = predGrid(SD0, popMat=popMatNGAThresh, nsim=1000, admLevel="stratMICS", 
                     quantiles=c(0.025, 0.1, 0.9, 0.975), sep=TRUE)
# repar M_d initialization:
# \begin{table}[ht]
# \centering
...
# \hline
# (Int) & -0.91 & -1.14 & -1.04 & -0.77 & -0.69 \\ 
# urb & 1.71 & 1.47 & 1.55 & 1.87 & 1.96 \\ 
# access & 0.00 & -0.08 & -0.05 & 0.05 & 0.08 \\ 
# elev & -0.00 & -0.09 & -0.06 & 0.06 & 0.10 \\ 
# distRiversLakes & 0.00 & -0.09 & -0.06 & 0.06 & 0.09 \\ 
# popValsNorm & 0.06 & -0.11 & -0.05 & 0.17 & 0.23 \\ 
# sigmaSq & 0.74 & 0.43 & 0.52 & 0.97 & 1.15 \\ 
# phi & 0.83 & 0.45 & 0.64 & 0.96 & 0.98 \\ 
# sigmaEpsSq & 1.96 & 1.69 & 1.78 & 2.15 & 2.25 \\ 
# \hline
# \end{tabular}
# \end{table}

# OLD basic intialization:
# \begin{table}[ht]
# \centering
# \begin{tabular}{rrrrrr}
# \hline
# & Est & Q0.025 & Q0.1 & Q0.9 & Q0.975 \\
# \hline
# (Int) & -0.95 & -1.16 & -1.08 & -0.83 & -0.75 \\
# urb & 1.70 & 1.47 & 1.56 & 1.86 & 1.93 \\
# access & 0.00 & -0.07 & -0.05 & 0.05 & 0.08 \\
# elev & -0.00 & -0.10 & -0.06 & 0.06 & 0.09 \\
# distRiversLakes & -0.00 & -0.09 & -0.06 & 0.06 & 0.09 \\
# popValsNorm & 0.07 & -0.12 & -0.05 & 0.18 & 0.24 \\
# sigmaSq & 0.76 & 0.46 & 0.53 & 1.00 & 1.18 \\
# phi & 0.83 & 0.46 & 0.63 & 0.96 & 0.98 \\
# sigmaEpsSq & 1.98 & 1.70 & 1.80 & 2.16 & 2.27 \\
# \hline
# \end{tabular}
# \end{table}

# OLD M_d initialization:
# \begin{table}[ht]
# \centering
# \begin{tabular}{rrrrrr}
# \hline
# & Est & Q0.025 & Q0.1 & Q0.9 & Q0.975 \\
# \hline
# (Int) & -2.67 & -3.14 & -2.98 & -2.35 & -2.19 \\
# urb & -0.40 & -0.75 & -0.63 & -0.18 & -0.07 \\
# access & -0.64 & -0.91 & -0.83 & -0.46 & -0.35 \\
# elev & 0.40 & 0.15 & 0.23 & 0.59 & 0.67 \\
# distRiversLakes & 0.27 & -0.03 & 0.08 & 0.46 & 0.56 \\
# popValsNorm & 1.41 & 0.80 & 1.01 & 1.81 & 2.00 \\
# sigmaSq & 0.87 & 0.53 & 0.60 & 1.19 & 1.39 \\
# phi & 0.84 & 0.48 & 0.65 & 0.97 & 0.98 \\
# sigmaEpsSq & 0.11 & 0.02 & 0.04 & 0.20 & 0.32 \\
# \hline
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsM_MSepRepar.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_MSepRepar.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_MSepRepar.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_MSepRepar.RData")
out = load("savedOutput/ed/stratPredsM_MSepRepar.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edFusionM_MSepRepar")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edFusionM_MSepRepar", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edFusionM_MSepRepar", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edFusionM_MSepRepar", plotNameRootAreal="Admin2")
