...
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsM_DM2SepRepar.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_DM2SepRepar.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_DM2SepRepar.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_DM2SepRepar.RData")
out = load("savedOutput/ed/stratPredsM_DM2SepRepar.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edFusionM_DM2SepRepar")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edFusionM_DM2SepRepar", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edFusionM_DM2SepRepar", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edFusionM_DM2SepRepar", plotNameRootAreal="Admin2")
