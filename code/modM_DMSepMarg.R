...
fitMDMMarg = function(datDHS=ed, datMICS=edMICS, inputsMDM=NULL, 
  ...
  ## specify random effects (alpha is explicit)
  ...
  data_full = list(
    ...
    V_bym2=bym2ArgsTMB$V,       # eigenvectors of Q
    alpha_pri=alpha_pri,
    beta_pri=beta_pri,
    tr=bym2ArgsTMB$tr,
  ...
  if(!any(file.exists(paste0("code/modM_DMSepMarg", c(".o", ".so", ".dll"))))) {
    print("compiling code/modM_DMSepMarg.cpp...")
    compile( "code/modM_DMSepMarg.cpp", 
             framework="TMBad", safebounds=FALSE)
  }
  
  # load dynlib, make tmb obj
  dyn.load( dynlib("code/modM_DMSepMarg"))
