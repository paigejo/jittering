...
if(FALSE) {
  ...
  dyn.unload( dynlib("code/modM_DMSepVarClustUR"))
  compile( "code/modM_DMSepVarClustUR.cpp", 
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitM_DMSepVarClustUR.RData")
out = load("savedOutput/ed/fitM_DMSepVarClustUR.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_DMSepVarClustUR.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_DMSepVarClustUR.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_DMSepVarClustUR.RData")
out = load("savedOutput/ed/stratPredsM_DMSepVarClustUR.RData")
out = load("savedOutput/ed/admin1PredsM_DMSepVarClustUR.RData")
out = load("savedOutput/ed/admin2PredsM_DMSepVarClustUR.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edFusionM_DMSepVarClustUR", plotNameRootAreal="Strat", CIwidthLims=zlimsStrat)
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edFusionM_DMSepVarClustUR", plotNameRootAreal="Admin1", CIwidthLims=zlimsAdmin1)
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edFusionM_DMSepVarClustUR", plotNameRootAreal="Admin2", CIwidthLims=zlimsAdmin2)
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=NULL, 
          plotNameRoot="edFusionM_DMSepVarClustUR", CIwidthLims=zlimsGrid)
