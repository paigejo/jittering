#!/bin/bash
#SBATCH --job-name regenScores      # Set a name for your job. This is especially useful if you have multiple jobs queued.
...
#SBATCH -o regenScores_%A_%a.out    # File to which STDOUT will be written
#SBATCH -e regenScores_%A_%a.err    # File to which STDERR will be written
...
Rscript --verbose regenScores.R ${SLURM_ARRAY_TASK_ID} > regenScores_${SLURM_ARRAY_JOB_ID}_${SLURM_ARRAY_TASK_ID}.Rout