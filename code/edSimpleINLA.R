...
system.time(mod <- runBYM2simple(dat=ordEd, covMat, strategy="eb", fast=FALSE, areaOrder=adm2$NAME_2))
summary(mod)
...
# NOTE: not sufficient to only include spatial effects and intercept
...
# \hline
# (Int) & -1.95 & -2.13 & -2.07 & -1.82 & -1.75 \\ 
# urb & 0.33 & 0.11 & 0.19 & 0.47 & 0.57 \\ 
# access & -0.21 & -0.32 & -0.27 & -0.14 & -0.10 \\ 
# elev & 0.19 & 0.03 & 0.08 & 0.29 & 0.35 \\ 
# distRiversLakes & 0.05 & -0.11 & -0.05 & 0.15 & 0.21 \\ 
# popValsNorm & 0.90 & 0.69 & 0.76 & 1.03 & 1.11 \\ 
# sigmaSq & 0.99 & 0.75 & 0.83 & 1.16 & 1.16 \\ 
# phi & 0.94 & 0.86 & 0.90 & 0.96 & 0.96 \\ 
# sigmaEpsSq & 0.92 & 0.79 & 0.82 & 1.04 & 1.08 \\ 
# \hline
# \end{tabular}
# \end{table}

save(gridPreds, file="savedOutput/ed/gridPredsSimpleINLA.RData")
out = load("savedOutput/ed/gridPredsSimpleINLA.RData")
...
# save(stratPreds, file="savedOutput/ed/stratPredsSimpleINLA.RData")
# save(admin1Preds, file="savedOutput/ed/admin1PredsSimpleINLA.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsSimpleINLA.RData")
# out = load("savedOutput/ed/stratPredsSimpleINLA.RData")
# out = load("savedOutput/ed/admin1PredsSimpleINLA.RData")
out = load("savedOutput/ed/admin2PredsSimpleINLA.RData")

# plotPreds(SD0, obj, popMat=popMatNGAThresh, 
#           gridPreds=gridPreds, arealPreds=NULL, 
#           plotNameRoot="edSimpleINLA")
# plotPreds(SD0, obj, popMat=popMatNGAThresh, 
#           gridPreds=gridPreds, arealPreds=stratPreds, 
#           plotNameRoot="edSimpleINLA", plotNameRootAreal="Strat")
# plotPreds(SD0, obj, popMat=popMatNGAThresh, 
#           gridPreds=gridPreds, arealPreds=admin1Preds, 
#           plotNameRoot="edSimpleINLA", plotNameRootAreal="Admin1")
plotPreds(SD0=NULL, tmbObj=NULL, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edSimpleINLA", plotNameRootAreal="Admin2")
