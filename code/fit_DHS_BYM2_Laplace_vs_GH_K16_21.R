#!/usr/bin/env Rscript
# DHS-only BYM2 comparison on BYM2-sim data with K=16/21 integration points
# Compares:
...
# -------------------------
cat("\n================================================================\n")
cat("DHS-only BYM2 (K=16/21): Laplace vs GH (Q=10)\n")
cat("================================================================\n")
