...
if(FALSE) {
  ...
  save(AUrbDHS, ARurDHS, intPtsDHS, 
       ...
       file="savedOutput/global/edSimpleIntInputs.RData")
  
  # compile model ----
  # dyn.unload( dynlib("code/modBYM2JitterDHS2sparse"))
  # compile( "code/modBYM2JitterDHS2sparse.cpp", framework="TMBad", safebounds=FALSE)
  
  dyn.unload( dynlib("code/modBYM2simpleInt"))
  compile( "code/modBYM2simpleInt.cpp", 
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitSimpleInt2.RData")
out = load("savedOutput/ed/fitSimpleInt2.RData")
...
# \hline
# (Int) & -0.42 & -0.59 & -0.53 & -0.30 & -0.24 \\ 
# sigmaSq & 1.95 & 1.77 & 1.83 & 2.09 & 2.17 \\ 
# phi & 0.94 & 0.92 & 0.93 & 0.95 & 0.95 \\ 
# sigmaEpsSq & 2.08 & 0.28 & 0.45 & 4.31 & 7.59 \\ 
# \hline
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsSimpleInt2.RData")
out = load("savedOutput/ed/gridPredsSimpleInt2.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsSimpleInt2.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsSimpleInt2.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsSimpleInt2.RData")
out = load("savedOutput/ed/stratPredsSimpleInt2.RData")
out = load("savedOutput/ed/admin1PredsSimpleInt2.RData")
out = load("savedOutput/ed/admin2PredsSimpleInt2.RData")
...
# \hline
# (Int) & -0.42 & -0.59 & -0.24 \\ 
# sigmaSq & 1.95 & 1.77 & 2.17 \\ 
# phi & 0.94 & 0.92 & 0.95 \\ 
# sigmaEpsSq & 2.08 & 0.28 & 7.59 \\
# \hline
# \end{tabular}
# \end{table}
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=NULL, 
          plotNameRoot="edSimpleInt2")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edSimpleInt2", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edSimpleInt2", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edSimpleInt2", plotNameRootAreal="Admin2")
