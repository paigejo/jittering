...
#   - LPT load-balanced callr workers (16) — M_DM_BYM2 fits dominate
...
scoreSimStudyParallel(model = "bym2", nsim = 10, nWorkers = 16,
                      NDRAWS = 1000, regenerate = TRUE)
scoreSimStudyParallel(model = "spde", nsim = 10, nWorkers = 16,
                      NDRAWS = 1000, regenerate = TRUE)
