...
if(FALSE) {
  ...
  save(areaidxlocUrban, areaidxlocRural, intPtsDHS, 
       ...
       file="savedOutput/global/edSimpleIntSepReparInputs.RData")
  
  # compile model ----
  # dyn.unload( dynlib("code/modBYM2JitterDHS2sparse"))
  # compile( "code/modBYM2JitterDHS2sparse.cpp", framework="TMBad", safebounds=FALSE)
  
  dyn.unload( dynlib("code/modBYM2simpleIntSepRepar"))
  compile("code/modBYM2simpleIntSepRepar.cpp", 
...
out = load("savedOutput/global/edSimpleIntSepReparInputs.RData")
...
rand_effs <- c('w_bym2Star', 'u_bym2Star', 'nuggetUrbDHS', 'nuggetRurDHS')
...
# obj$par = optPar
{
  ...
  # optimization took 0.0375500000004346 minutes (for intern=FALSE)
}
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitSimpleIntSepRepar.RData")
out = load("savedOutput/ed/fitSimpleIntSepRepar.RData")

predCols = makeBlueGreenYellowSequentialColors(64)
quantCols = makePurpleYellowSequentialColors(64)

testRep = obj$report()
plotMapDat(adm2, expit(testRep$w_bym2Star), varAreas=adm2$NAME_2, 
...
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsSimpleIntSepRepar.RData")
out = load("savedOutput/ed/gridPredsSimpleIntSepRepar.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsSimpleIntSepRepar.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsSimpleIntSepRepar.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsSimpleIntSepRepar.RData")
out = load("savedOutput/ed/stratPredsSimpleIntSepRepar.RData")
out = load("savedOutput/ed/admin1PredsSimpleIntSepRepar.RData")
out = load("savedOutput/ed/admin2PredsSimpleIntSepRepar.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edSimpleIntSepRepar")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edSimpleIntSepRepar", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edSimpleIntSepRepar", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edSimpleIntSepRepar", plotNameRootAreal="Admin2")
