// DHS-only IID spatial + GH nuggets
// Same likelihood structure as modD_BYM2_GH_v2.cpp but with
// IID N(0, 1/tau) spatial effects replacing BYM2
// DHS uses Aproj matrices to project spatial effects to integration points
...
Type objective_function<Type>::operator() ()
{
  ...
  // Project spatial effects via Aproj
  vector<Type> proj_urb = (AprojUrbanDHS * v_iid.matrix()).col(0);
  vector<Type> proj_rur = (AprojRuralDHS * v_iid.matrix()).col(0);
