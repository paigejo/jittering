source("code/setup.R")
# MICS-only BYM2 GH model: fit, predictions and plots
...
Qgh   <- 10
KMICS <- 100
res = fitMM(datDHS=ed, datMICS=edMICS, KMICS=KMICS, Qgh=Qgh, getSDs=TRUE, verbose=FALSE)
SD0 = res$TMBsd
obj  = res$TMBobj
...
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          ...
          plotNameRoot="edM_M_final", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=admin1Preds,
          plotNameRoot="edM_M_final", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=admin2Preds,
          plotNameRoot="edM_M_final", plotNameRootAreal="Admin2")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=NULL,
          plotNameRoot="edM_M_final")
