...
if(FALSE) {
  ...
  save(areaidxlocUrban, areaidxlocRural, intPtsDHS, 
       ...
       file="savedOutput/global/edSimpleIntConstr2Inputs.RData")
  
  # compile model ----
  # dyn.unload( dynlib("code/modBYM2JitterDHS2sparse"))
  # compile( "code/modBYM2JitterDHS2sparse.cpp", framework="TMBad", safebounds=FALSE)
  
  dyn.unload( dynlib("code/modBYM2SimpleIntConstr2"))
  compile( "code/modBYM2SimpleIntConstr2.cpp", 
...
out = load("savedOutput/global/edSimpleIntConstr2Inputs.RData")
...
rand_effs <- c('Epsilon_bym2', 'nuggetUrbDHS', 'nuggetRurDHS', 'alpha')
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitSimpleIntConstr22.RData")
out = load("savedOutput/ed/fitSimpleIntConstr22.RData")
...
# \hline
# (Int) & -0.67 & -0.77 & -0.73 & -0.60 & -0.57 \\ 
# sigmaSq & 0.07 & 0.05 & 0.06 & 0.08 & 0.08 \\ 
# phi & 0.44 & 0.13 & 0.19 & 0.69 & 0.79 \\ 
# sigmaEpsSq & 1.53 & 1.28 & 1.37 & 1.70 & 1.80 \\ 
# \hline
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsSimpleIntConstr22.RData")
out = load("savedOutput/ed/gridPredsSimpleIntConstr22.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsSimpleIntConstr22.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsSimpleIntConstr22.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsSimpleIntConstr22.RData")
out = load("savedOutput/ed/stratPredsSimpleIntConstr22.RData")
out = load("savedOutput/ed/admin1PredsSimpleIntConstr22.RData")
out = load("savedOutput/ed/admin2PredsSimpleIntConstr22.RData")
...
# \hline
# (Int) & -0.67 & -0.77 & -0.57 \\ 
# sigmaSq & 0.07 & 0.05 & 0.08 \\ 
# phi & 0.44 & 0.13 & 0.79 \\ 
# sigmaEpsSq & 1.53 & 1.28 & 1.80 \\ 
# \hline
# \end{tabular}
# \end{table}
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=NULL, 
          plotNameRoot="edSimpleIntConstr22")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edSimpleIntConstr22", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edSimpleIntConstr22", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edSimpleIntConstr22", plotNameRootAreal="Admin2")
