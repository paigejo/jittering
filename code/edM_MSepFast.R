...
out = load("savedOutput/global/edM_MFastInputs.RData")
...
dyn.load( dynlib("code/modM_MSepFast"))
...

{
  ...
  # optimization took 16.4521333333328 minutes (for basic initialization)
  # optimization took 21.7034499999999 minutes (for Md initialization)
}
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitM_MSepFast.RData")
out = load("savedOutput/ed/fitM_MSepFast.RData")
...
# \hline
# (Int) & -0.91 & -1.09 & -1.02 & -0.80 & -0.75 \\ 
# urb & 1.80 & 1.60 & 1.66 & 1.93 & 2.02 \\ 
# access & -0.00 & -0.04 & -0.03 & 0.03 & 0.04 \\ 
# elev & -0.00 & -0.05 & -0.03 & 0.03 & 0.05 \\ 
# distRiversLakes & 0.00 & -0.05 & -0.03 & 0.04 & 0.06 \\ 
# popValsNorm & -0.00 & -0.06 & -0.04 & 0.04 & 0.06 \\ 
# sigmaSq & 0.79 & 0.47 & 0.55 & 1.06 & 1.25 \\ 
# phi & 0.82 & 0.45 & 0.63 & 0.96 & 0.98 \\ 
# sigmaEpsSq & 1.97 & 1.70 & 1.80 & 2.17 & 2.26 \\ 
# \hline
# \end{tabular}
# \end{table}
...
# & Est & Q0.025 & Q0.1 & Q0.9 & Q0.975 \\
# \hline
# (Int) & -0.98 & -1.14 & -1.09 & -0.88 & -0.82 \\ 
# urb & 1.83 & 1.63 & 1.69 & 1.97 & 2.04 \\ 
# access & 0.01 & -0.03 & -0.02 & 0.04 & 0.06 \\ 
# elev & 0.00 & -0.05 & -0.03 & 0.04 & 0.06 \\ 
# distRiversLakes & 0.01 & -0.05 & -0.03 & 0.04 & 0.06 \\ 
# popValsNorm & 0.02 & -0.04 & -0.02 & 0.06 & 0.08 \\ 
# sigmaSq & 0.80 & 0.46 & 0.57 & 1.06 & 1.26 \\ 
# phi & 0.82 & 0.43 & 0.62 & 0.96 & 0.98 \\ 
# sigmaEpsSq & 1.65 & 1.41 & 1.48 & 1.82 & 1.94 \\ 
# \hline
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsM_MSepFast.RData")
out = load("savedOutput/ed/gridPredsM_MSepFast.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_MSepFast.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_MSepFast.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_MSepFast.RData")
out = load("savedOutput/ed/stratPredsM_MSepFast.RData")
out = load("savedOutput/ed/admin1PredsM_MSepFast.RData")
out = load("savedOutput/ed/admin2PredsM_MSepFast.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edFusionM_MSepFast")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edFusionM_MSepFast", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edFusionM_MSepFast", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edFusionM_MSepFast", plotNameRootAreal="Admin2")
