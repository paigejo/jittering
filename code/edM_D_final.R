source("code/setup.R")
# DHS-only BYM2 GH model: fit, predictions and plots
...
KDHSu  <- 16
KDHSr  <- 21
res = fitMD(datDHS=ed, datMICS=edMICS, KDHSurb=KDHSu, KDHSrur=KDHSr, Qgh=Qgh, getSDs=TRUE, verbose=FALSE)
SD0 = res$TMBsd
obj  = res$TMBobj
...
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          ...
          plotNameRoot="edM_D_final", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=admin1Preds,
          plotNameRoot="edM_D_final", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=admin2Preds,
          plotNameRoot="edM_D_final", plotNameRootAreal="Admin2")
plotPreds(SD0, obj, popMat=popMatNGAThresh,
          gridPreds=gridPreds, arealPreds=NULL,
          plotNameRoot="edM_D_final")
