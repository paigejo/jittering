...
if(FALSE) {
  ...
  save(AUrbDHS, ARurDHS, intPtsDHS, 
       ...
       file="savedOutput/global/edSimpleIntConstrInputs.RData")
  
  # compile model ----
  # dyn.unload( dynlib("code/modBYM2JitterDHS2sparse"))
  # compile( "code/modBYM2JitterDHS2sparse.cpp", framework="TMBad", safebounds=FALSE)
  
  dyn.unload( dynlib("code/modBYM2SimpleIntConstr"))
  compile( "code/modBYM2SimpleIntConstr.cpp", 
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitSimpleIntConstr2.RData")
out = load("savedOutput/ed/fitSimpleIntConstr2.RData")
...
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsSimpleIntConstr2.RData")
out = load("savedOutput/ed/gridPredsSimpleIntConstr2.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsSimpleIntConstr2.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsSimpleIntConstr2.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsSimpleIntConstr2.RData")
out = load("savedOutput/ed/stratPredsSimpleIntConstr2.RData")
out = load("savedOutput/ed/admin1PredsSimpleIntConstr2.RData")
out = load("savedOutput/ed/admin2PredsSimpleIntConstr2.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edSimpleIntConstr2")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edSimpleIntConstr2", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edSimpleIntConstr2", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edSimpleIntConstr2", plotNameRootAreal="Admin2")
