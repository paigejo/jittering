...
# dyn.load( dynlib("code/modM_DSepReparVarClustsparse"))
...

{
  ...
  # optimization took 1.07678333333327 minutes (for intern=FALSE)
}
...
save(SD0, obj, totalTime, sdTime, file="savedOutput/ed/fitM_DSepReparVarClust.RData")
out = load("savedOutput/ed/fitM_DSepReparVarClust.RData")

gridPreds = predGrid(SD0, popMat=popMatNGAThresh, nsim=1000, admLevel="stratMICS", 
                     quantiles=c(0.025, 0.1, 0.9, 0.975), sep=TRUE)
# single clust results with final repar:
# \begin{table}[ht]
# \centering
...
# \end{tabular}
# \end{table}
save(gridPreds, file="savedOutput/ed/gridPredsM_DSepReparVarClust.RData")
out = load("savedOutput/ed/gridPredsM_DSepReparVarClust.RData")
...
save(stratPreds, file="savedOutput/ed/stratPredsM_DSepReparVarClust.RData")
save(admin1Preds, file="savedOutput/ed/admin1PredsM_DSepReparVarClust.RData")
save(admin2Preds, file="savedOutput/ed/admin2PredsM_DSepReparVarClust.RData")
out = load("savedOutput/ed/stratPredsM_DSepReparVarClust.RData")
out = load("savedOutput/ed/admin1PredsM_DSepReparVarClust.RData")
out = load("savedOutput/ed/admin2PredsM_DSepReparVarClust.RData")
...
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          ...
          plotNameRoot="edFusionM_DSepReparVarClust")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=stratPreds, 
          plotNameRoot="edFusionM_DSepReparVarClust", plotNameRootAreal="Strat")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin1Preds, 
          plotNameRoot="edFusionM_DSepReparVarClust", plotNameRootAreal="Admin1")
plotPreds(SD0, obj, popMat=popMatNGAThresh, 
          gridPreds=gridPreds, arealPreds=admin2Preds, 
          plotNameRoot="edFusionM_DSepReparVarClust", plotNameRootAreal="Admin2")
